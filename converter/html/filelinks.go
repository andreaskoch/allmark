...
func renderFileLinks(item *repository.Item, rawContent string) string {
	return convertFileLinksMarkdownExtension(rawContent, item.Files, item.FilePathProvider())
}
